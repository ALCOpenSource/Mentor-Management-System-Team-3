    ...
    <div className='flex flex-row'>
      ...
      <form onSubmit={handleSubmit} className="w-full mx-auto m-40">
        ...
        <div className="relative my-4">
          ...
          />
          <img className="h-10 w-10 text-white absolute inset-y-0 right-0 flex items-center pr-3" src='/images/eyepassword.jpg' alt='Password'/>             
        </div>  
        ...
        <div className='flex flex-col'>
          <a href="#" className="text-sm text-black text-end hover:text-indigo-700 w-full py-2 px-3 m-2">Forgot password?</a>        
          ...
          <span className="text-gray-600 text-center text-sm w-full py-2 px-3">New user? <a href="#" className="text-black">Sign up</a></span>
        </div>                
      </form>
    </div>
