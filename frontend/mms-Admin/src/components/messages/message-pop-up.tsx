...
function MessagePopUpPage(props: {
  ...
  return (
    ...
    >
       <div className="relative bg-white w-[420px] ml-auto mr-auto h-[100%] max-h-[370px] mt-[50px] border-gray-200 border-[4px] rounded-lg p-0 border-solid overflow-x-hidden overflow-y-hidden">
